...
train_lmdb = '/opt/caffe-gpu/py-faster-rcnn/experiments/deeplearning-cats-dogs-tutorial/inputtrain_lmdb'
validation_lmdb = '/opt/caffe-gpu/py-faster-rcnn/experiments/deeplearning-cats-dogs-tutorial/input/validation_lmdb'
